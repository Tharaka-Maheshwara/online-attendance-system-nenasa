...
async function testEndpoints() {
  ...
  try {
    ...
    const studentsResponse = await fetch(
      `${BASE_URL}/students/${TEST_GRADE}/${encodeURIComponent(TEST_SUBJECT)}`,
    );
    ...
    const analysisResponse = await fetch(
      `${BASE_URL}/attendance/${TEST_GRADE}/${encodeURIComponent(TEST_SUBJECT)}`,
    );
    ...
    const monthlyResponse = await fetch(
      `${BASE_URL}/time-range/${TEST_GRADE}/${encodeURIComponent(TEST_SUBJECT)}/month`,
    );
    ...
    const paymentResponse = await fetch(
      `${BASE_URL}/payments/${TEST_GRADE}/${encodeURIComponent(TEST_SUBJECT)}`,
    );
    ...
    const comprehensiveResponse = await fetch(
      `${BASE_URL}/comprehensive/${TEST_GRADE}/${encodeURIComponent(TEST_SUBJECT)}`,
    );
    const comprehensive = await comprehensiveResponse.json();
    console.log(
      '✅ Comprehensive analysis with payment summary:',
      !!comprehensive.paymentSummary,
    );
    console.log('');
    ...
    const chartResponse = await fetch(
      `${BASE_URL}/chart-data/${TEST_GRADE}/${encodeURIComponent(TEST_SUBJECT)}?timeRange=week`,
    );
